...
#define ORDERED_PRINT
	...
	public:
		...
		// DB access
		const UnderstandHandle& getDBHandle(){return m_handle;}
		void				setDBHandle(const UnderstandHandle& handle){m_handle = handle;}
...
#define TREE_USE_RECURSIVE_OUTPUT
	public:
		...
		const QSet<SymbolNode::Ptr> getDirtyProject()const;
