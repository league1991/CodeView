...
void CodeAtlas::VariableUIItem::initIconList()
{
	if (m_publicImgArray[0].isEmpty())
		m_publicImgArray[0].loadImage(QImage("Resources/publicVar.png"), QSize(150,150));
	if (m_protectedImgArray[0].isEmpty())
		m_protectedImgArray[0].loadImage(QImage("Resources/protectedVar.png"), QSize(150,150));
	if (m_privateImgArray[0].isEmpty())
		m_privateImgArray[0].loadImage(QImage("Resources/privateVar.png"), QSize(150,150));

	if (m_publicImgArray[1].isEmpty())
		m_publicImgArray[1].loadImage(QImage("Resources/publicVarHover.png"), QSize(150,150));
	if (m_protectedImgArray[1].isEmpty())
		m_protectedImgArray[1].loadImage(QImage("Resources/protectedVarHover.png"), QSize(150,150));
	if (m_privateImgArray[1].isEmpty())
		m_privateImgArray[1].loadImage(QImage("Resources/privateVarHover.png"), QSize(150,150));

	if (m_publicImgArray[2].isEmpty())
		m_publicImgArray[2].loadImage(QImage("Resources/publicVarSelected.png"), QSize(150,150));
	if (m_protectedImgArray[2].isEmpty())
		m_protectedImgArray[2].loadImage(QImage("Resources/protectedVarSelected.png"), QSize(150,150));
	if (m_privateImgArray[2].isEmpty())
		m_privateImgArray[2].loadImage(QImage("Resources/privateVarSelected.png"), QSize(150,150));
}
...
void CodeAtlas::VariableUIItem::paint( QPainter *painter, const QStyleOptionGraphicsItem *option/* =0 */, QWidget *widget /* = 0 */ )
{
	...
	painter->setBrush(QBrush(QColor(155,192,67,255)));
